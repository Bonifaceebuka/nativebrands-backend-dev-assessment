                ...
                <div class="navbar-end">
                    ...
                    <div id="account-dropdown" class="navbar-item is-account drop-trigger has-caret">
                        <div class="user-image">
                            ...
                            data-demo-src="{{$BaseController->find_image('profile_image',Auth::user()->id)}}" alt="">
                            <span class="indicator"></span>
                        </div>
                        ...
                        <div class="nav-drop is-account-dropdown">
                            <div class="inner">
                                <div class="nav-drop-header">
                                    <span class="username">{{$BaseController->full_name(Auth::user()->id)}}</span>
                                ...
                                <div class="nav-drop-body account-items">
                                    ...
                                    <hr class="account-divider">
                                    <a href="{{route('user.setting.index')}}" class="account-item">
                                        <div class="media">
                                            <div class="icon-wrap">
                                    ...
                                    <a class="account-item">
                                        <div class="media">
                                            ...
                                            <div class="media-content">
                                                ...
                                                document.getElementById('logout-form').submit();">Log out</h3>
