            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="button is-solid accent-button 
                        replace-button is-disabled">Use Picture</button>
                    </div>
                </div>
        ...
        <div id="upload-crop-cover-modal" class="modal upload-crop-cover-modal is-large has-light-bg">
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <form action="#" method="POST" id="upload-cover-picture-form">
                        @csrf
                    <div class="card-body">
                        <div class="alert text-center cover-picture-msg"></div>
                        <label class="cover-uploader-box" for="upload-cover-picture">
                            ...
                            <input type="file" id="upload-cover-picture" 
                            name="upload-cover-picture" accept="image/*">
                        </label>
                    ...
                    <div class="card-footer">
                        <button id="submit-cover-picture" type="submit"
