                            ...
                            <div id="upload-crop-profile-modal" class="modal upload-crop-profile-modal is-xsmall has-light-bg">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="card">
                                            ...
                                            <form action="/settings/profile-image" method="POST" id="upload-profile-picture-form">
                                            @csrf
                                            <div class="card-body">
                                                <label class="profile-uploader-box" for="upload-profile-picture">
                                                    ...
                                                    <input type="file" id="upload-profile-picture" 
                                                    name="upload_profile_picture" accept="image/*">
                                                </label>
                                            ...
                                            <div class="card-footer">
                                                ...
                                                class="button is-solid accent-button is-fullwidth raised 
                                                is-disabled cccccc" type="submit">Use Picture</button>
                                            </div>
                                        </form>
                                        </div>
